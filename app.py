...
col4.metric('Flight Distance', mt.calc_flight_distance(flight_data['lat'], flight_data['lon'], user_unit))
col5.metric('Max Distance from Home', mt.calc_max_distance(flight_data['lat'], flight_data['lon'], user_unit))
